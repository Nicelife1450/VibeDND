...
class DefectDatasetBuilder:
                ...
                if len(parts) >= 2 and parts[1].strip():
                    ...
                    for sep2 in separators:
                        ...
                        if len(parts2) >= 2 and parts2[1].strip():
                            ...
                            # 验证：杆号应该包含数字
                            if any(c.isdigit() for c in potential_pole):
    ...
    def process_image(self, annotated_img_path: Path, original_img_path: Path, 
        ...
        try:
            ...
            category_id = self.get_or_create_category(defect_info['defect_type'])
            
            self.defect_severity[defect_info['defect_type']] = defect_info['severity']
    ...
    def build_dataset(self):
        ...
        for folder in inspection_folders:
            ...
            for annotated_img in annotated_images:
                ...
                original_img = self.find_original_image(annotated_img, original_base)
                if not original_img:
                ...
                success = self.process_image(annotated_img, original_img, defect_info)
